...
export const STACKABLE_FILTERS = {
	...
	'stackable/button': [ 'text', 'icon', 'linkHasLink', 'linkUrl', 'linkNewTab', 'linkRel', 'linkHasTitle', 'linkTitle', 'linkCustomAttributes' ],
	'stackable/text': [ 'text' ],
	...
	'stackable/icon': [ 'icon' ],
	'stackable/icon-button': [ 'icon', 'linkHasLink', 'linkUrl', 'linkNewTab', 'linkRel', 'linkHasTitle', 'linkTitle', 'linkCustomAttributes' ],
