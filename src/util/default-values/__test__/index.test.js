...
describe( 'inheritDesktopAttribute', () => {
	it( 'should generate a default value based on desktop\'s attribute', () => {
		...
		expect( inheritDesktopAttribute( '10', 'px' ) ).toBe( '10px !important' )
		expect( inheritDesktopAttribute( '10', 'vh', 20 ) ).toBe( '10vh !important' )
		expect( inheritDesktopAttribute( '20', 'vh', 10 ) ).toBe( '10vh !important' )
		expect( inheritDesktopAttribute( '10', 'vh', 20, false ) ).toBe( '10vh' )
		expect( inheritDesktopAttribute( '10', 'vh', 20, true ) ).toBe( '10vh !important' )
	} )
} )
