...
const typographyOptions = {
	selector: [
		'.stk-block-icon-list__ul .stk-block-icon-list-item',
		'.stk-block-icon-list__ol .stk-block-icon-list-item',
	],
	hoverSelector: [
		'.%s:hover .stk-block-icon-list__ul .stk-block-icon-list-item',
		'.%s:hover .stk-block-icon-list__ol .stk-block-icon-list-item',
	],
}
...
const Styles = props => {
	...
	return (
		<>
			...
			<BlockCss
				{ ...propsToPass }
				selector=".stk-block-icon-list__ol"
			...
			<BlockCss
				{ ...propsToPass }
				selector=".stk-block-icon-list__ul .stk-block-icon-list-item__content .stk--svg-wrapper"
			...
			<BlockCss
				{ ...propsToPass }
				selector={ [ '.stk-block-icon-list__ul .stk-block-icon-list-item__content .stk--inner-svg', '.stk-block-icon-list__ol .stk-block-icon-list-item__content .stk-block-icon-list-item__marker' ] }
				styleRule="transform"
