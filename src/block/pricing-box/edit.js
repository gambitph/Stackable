		...
		<Fragment>
			<InspectorControls>
				<DesignPanelBody
					...
					options={ [
						{
							image: 'src/block/pricing-box/images/basic.png', label: __( 'Basic' ), value: 'basic',
						},
						{
							image: 'src/block/pricing-box/images/plain.png', label: __( 'Plain' ), value: 'plain',
						},
							...
							<div className={ boxClasses } style={ boxStyle }>
								...
								>
									<ImageUploadPlaceholder
										...
										imageURL={ imageURL }
										onRemove={ () => {
											setAttributes( { [ `imageURL${ index }` ]: '', [ `imageID${ index }` ]: '' } )
										} }
										onChange={ ( { url, id } ) => {
											setAttributes( { [ `imageURL${ index }` ]: url, [ `imageID${ index }` ]: id } )
										} }
