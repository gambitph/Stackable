	...
	if ( showIcon ) {
		...
		styles.push( {
			'.ugb-notification__icon': {
				marginLeft: iconAlign !== '' || contentAlign !== '' ? marginLeftAlign( iconAlign || contentAlign ) : undefined,
				marginRight: iconAlign !== '' || contentAlign !== '' ? marginRightAlign( iconAlign || contentAlign ) : undefined,
