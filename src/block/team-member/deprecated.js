...
const deprecatedSchema_1_10 = {
	...
	mediaURL1: {
		type: 'string',
		source: 'attribute',
		selector: 'div:nth-child(1) > .ugb-team-member-item .team-member-image',
		attribute: 'data-src',
	},
	mediaURL2: {
		type: 'string',
		source: 'attribute',
		selector: 'div:nth-child(2) > .ugb-team-member-item .team-member-image',
		attribute: 'data-src',
	},
	mediaURL3: {
		type: 'string',
		source: 'attribute',
		selector: 'div:nth-child(3) > .ugb-team-member-item .team-member-image',
		attribute: 'data-src',
	},
	name1: {
		source: 'html',
		selector: 'div:nth-child(1) > .ugb-team-member-item h4',
		default: __( 'Name' ),
	},
	name2: {
		source: 'html',
		selector: 'div:nth-child(2) > .ugb-team-member-item h4',
		default: __( 'Name' ),
	},
	name3: {
		source: 'html',
		selector: 'div:nth-child(3) > .ugb-team-member-item h4',
		default: __( 'Name' ),
	},
	position1: {
		source: 'html',
		selector: 'div:nth-child(1) > .ugb-team-member-item .ugb-team-member-position',
		default: __( 'Position' ),
	},
	position2: {
		source: 'html',
		selector: 'div:nth-child(2) > .ugb-team-member-item .ugb-team-member-position',
		default: __( 'Position' ),
	},
	position3: {
		source: 'html',
		selector: 'div:nth-child(3) > .ugb-team-member-item .ugb-team-member-position',
		default: __( 'Position' ),
	},
	description1: {
		source: 'html',
		selector: 'div:nth-child(1) > .ugb-team-member-item .ugb-team-member-desc',
		default: descriptionPlaceholder( 'medium' ),
	},
	description2: {
		source: 'html',
		selector: 'div:nth-child(2) > .ugb-team-member-item .ugb-team-member-desc',
		default: descriptionPlaceholder( 'medium' ),
	},
	description3: {
		source: 'html',
		selector: 'div:nth-child(3) > .ugb-team-member-item .ugb-team-member-desc',
		default: descriptionPlaceholder( 'medium' ),
	},
	nameColor: {
		type: 'string',
