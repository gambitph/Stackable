...
export const createStyles = props => {
	...
	if ( show.imageSpacing ) {
		styles.push( ...createResponsiveStyles( '.ugb-BLOCKSLUG__image', 'image%sBottomMargin', 'marginBottom', '%spx', props.attributes, true ) )
	}
	if ( show.titleSpacing ) {
		styles.push( ...createResponsiveStyles( '.ugb-BLOCKSLUG__title', 'title%sBottomMargin', 'marginBottom', '%spx', props.attributes, true ) )
	}
	if ( show.descriptionSpacing ) {
		styles.push( ...createResponsiveStyles( '.ugb-BLOCKSLUG__description', 'description%sBottomMargin', 'marginBottom', '%spx', props.attributes, true ) )
	}
