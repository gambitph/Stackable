 ...
 */
import {
	getFontFamily, clampInheritedStyle, attributeHasValue,
} from '~stackable/util'
...
const Styles = props => {
	...
	return (
		<>
			{ attributeHasValue( 'textShadow', attributes, { hasHover: true, attrNameTemplate } ) &&
				<BlockCss
					{ ...propsToPass }
					selector={ selector }
			...
			{ attributeHasValue( 'fontSize', attributes, { hasResponsive: true, attrNameTemplate } ) &&
				<BlockCss
					{ ...propsToPass }
					selector={ selector }
					selectorCallback={ selectorCallback }
			...
			{ attributeHasValue( 'textRemoveTextMargins', attributes, { attrNameTemplate } ) &&
				<BlockCss
					{ ...propsToPass }
					selector={ selector }
					selectorCallback={ selectorCallback }
			...
			{ attributeHasValue( 'textColor1', attributes, { hasHover: true, attrNameTemplate } ) &&
				<BlockCss
					{ ...propsToPass }
					selector={ selector }
					selectorCallback={ selectorCallback }
			...
			{ attributeHasValue( 'textColor1', attributes, { attrNameTemplate } ) &&
				<BlockCss
					{ ...propsToPass }
					selector={ selector }
					selectorCallback={ selectorCallback }
			...
			{ attributeHasValue( 'lineHeight', attributes, { hasResponsive: true, attrNameTemplate } ) &&
				<BlockCss
					{ ...propsToPass }
					selector={ selector }
					selectorCallback={ selectorCallback }
			...
			{ attributeHasValue( 'fontWeight', attributes, { attrNameTemplate } ) &&
				<BlockCss
					{ ...propsToPass }
					selector={ selector }
					selectorCallback={ selectorCallback }
			...
			{ attributeHasValue( 'textTransform', attributes, { attrNameTemplate } ) &&
				<BlockCss
					{ ...propsToPass }
					selector={ selector }
					selectorCallback={ selectorCallback }
			...
			{ attributeHasValue( 'fontStyle', attributes, { attrNameTemplate } ) &&
				<BlockCss
					{ ...propsToPass }
					selector={ selector }
					selectorCallback={ selectorCallback }
			...
			{ attributeHasValue( 'fontFamily', attributes, { attrNameTemplate } ) &&
				<BlockCss
					{ ...propsToPass }
					selector={ selector }
					selectorCallback={ selectorCallback }
			...
			{ attributeHasValue( 'letterSpacing', attributes, { attrNameTemplate } ) &&
				<BlockCss
					{ ...propsToPass }
					selector={ selector }
					selectorCallback={ selectorCallback }
