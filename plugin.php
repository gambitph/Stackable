...
defined( 'STACKABLE_VERSION' ) || define( 'STACKABLE_VERSION', '3.11.4' );
...
require_once( plugin_dir_path( __FILE__ ) . 'src/block-components/image/deprecated/gradient-overlay.php' );
