...
module.exports = [ {
	...
	entry: {
        ...
        'editor_blocks_deprecated_v2': path.resolve( __dirname, '../src/deprecated/v2/blocks.js' ),
    },
...
},
{
	...
	entry: {
		...
		'frontend_blocks_deprecated_v2': path.resolve( __dirname, '../src/deprecated/v2/block-frontend.js' ),
